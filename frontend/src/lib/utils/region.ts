...
//     return `/country/${range}/${country}/${mostRecent.month}/${mostRecent.year}`;
//   }
//   return `/country/${range}/${country}/NA/NA`;
// }
...
export function computeHomePath(
  ...
  if (country === "global") {
    if (uploads.length > 0) {
      ...
      return `/country/${range}/global/${mostRecent.month}/${mostRecent.year}`;
    }
    return `/country/${range}/global/NA/NA`;
  }
