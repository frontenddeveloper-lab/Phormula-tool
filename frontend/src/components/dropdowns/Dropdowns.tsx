...
//           <div className="flex flex-wrap justify-between gap-6 md:gap-4">
//             <div className="flex-1 min-w-[300px]">
//               <CircleChart range={range} year={selectedYear} countryName={initialCountryName} homeCurrency={globalHomeCurrency} />
//             </div>
//             <div className="flex-1 min-w-[300px]">
//               <CMchartofsku range={range} year={selectedYear} countryName={initialCountryName} homeCurrency={globalHomeCurrency} />
//             </div>
//           </div>
//           <SKUtable range={range} year={selectedYear} countryName={initialCountryName} homeCurrency={globalHomeCurrency} />
//         </>
//       )}
