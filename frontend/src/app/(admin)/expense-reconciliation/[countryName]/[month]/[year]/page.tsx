...
export async function generateMetadata({
  ...
  return {
    title,
    description: `Expense Reconciliation dashboard for ${country} in ${monthFormatted} ${year}. Review sales summaries, referral fee breakdowns, and product-wise overcharge details.`,
