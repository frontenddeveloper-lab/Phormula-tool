...
const blob = new Blob(buffers, {
  ...
  .tablec tbody tr:nth-child(even) { background-color: #5EA68E33; }
        ...
        .fetch-button { padding: 10px 16px; font-size: 0.9rem; border: none; border-radius: 6px; cursor: pointer; transition: background-color 0.2s ease; box-shadow: 0 3px 6px rgba(0,0,0,0.15); white-space: nowrap; font-family: 'Lato', sans-serif; background-color: #2c3e50; color: #f8edcf; font-weight: bold; }
