...
// import { platformToCountryName } from "@/lib/utils/platforms";
...
//     const periodRaw = localStorage.getItem("latestFetchedPeriod");
//     if (periodRaw) {
//       try {
//         const p = JSON.parse(periodRaw) as { month?: string; year?: string };
//         if (p.month) month = String(p.month).toLowerCase();
//         if (p.year) year = String(p.year);
//       } catch {}
//     }

//     const platform = localStorage.getItem("selectedPlatform") || "global";
//     const country = platformToCountryName(platform as any) || "global";

//     router.replace(`/real-time/${country}/${month}/${year}`);
//   }, [router]);
